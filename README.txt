...
O funcionamento do google-bot, que depende dos TADs e das operações que usam essas TADs, podem ser encontradas em Util/. La teremos os arquivos relacionados a DLL *(dll.h e item.h)*, a AVL *(AVL.h e item2.h)*, bem como ao arquivo que contem as operações do site e outras funções uteis *(op.h)*.
